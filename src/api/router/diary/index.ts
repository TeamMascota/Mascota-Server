...
router.post('/prologue',upload.single('images'),diaryController.postPrologue) //1부 프롤로그 작성
router.post('/pet',upload.array('images',5),diaryController.postPetDiary)//반려동물 일기 작성
